...
namespace IngameScript
{
    ...
    {   //Introduction
         ...
         * //Update 1.04
         * Hotfixed batter recharge issue
         * // Updade 1.05
         * Fixed thruster low power issue as incorrectly clamped
         * Added Automatic Firing
         */
        ...
        //CHANGE AUTOLAUNCH HERE
        //change to 'true' if automatic launch is required
        bool AutoLaunch = false;
        int Milliseconds_Between_Launch = 180;

        //CHANGE TOW Rayscan Distance HERE
        //(~note this section is in development, and might not work correctly)
        //change to whatever distance is required, note that rayscan at longer ranges will be overriden by close up targets
        double TOW_Distance = 3000;
        //change this to true if you always want the missile able to set priority to rayscanned object
        ...
        class MISSILE
        {
            ...
            public List<IMyTerminalBlock> WARHEADS = new List<IMyTerminalBlock>(); //Multiple
                                                                                   //public IMyTerminalBlock MatingMergeBlock; //The Mating Merge Block used for launch distance calculation
        ...
        void Main(string argument)
        {
            ...
            if (Turret != null)
            {
                bool HasTarget = !Turret.GetTargetedEntity().IsEmpty(); //If Turret Detects Enemy
